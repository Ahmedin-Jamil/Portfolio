...
const translationsEn: Record<string, string> = {
  ...
  'about.description2': 'During my internship at the University of the Cordilleras Office of Student Affairs, I contributed to UC AIwan+ by developing web interfaces and internal tools including mental health modules, emotion tracking, AI-driven analytics, and a 3D gamified career map. I also partnered with a local business to deliver the Baguio Pet Boarding Platform, a complete booking management system with AI chatbot integration.',
  ...
  'portfolio.project1.desc': 'Developed and delivered a full-stack pet boarding management system in partnership with a local business. Features include client booking journey, admin workflow, service selection and scheduling, booking/request tracking, and dashboard views. Built using React, TypeScript, and Supabase with integrated AI chatbot for customer support.',
...
const translationsAr: Record<string, string> = {
  ...
  'about.description2': 'خلال تدريبي في مكتب شؤون الطلاب بجامعة كورديليراس، ساهمت في UC AIwan+ من خلال تطوير واجهات الويب والأدوات الداخلية بما في ذلك وحدات الصحة النفسية وتتبع المشاعر والتحليلات المدعومة بالذكاء الاصطناعي وخريطة مهنية ثلاثية الأبعاد. كما شاركت مع شركة محلية لتقديم منصة Baguio Pet Boarding، وهو نظام إدارة حجوزات كامل مع دمج روبوت محادثة ذكي.',
  ...
  'portfolio.project1.desc': 'طورت وقدمت نظام إدارة حجوزات متكامل لرعاية الحيوانات الأليفة بالشراكة مع شركة محلية. يتضمن رحلة حجز العميل وسير عمل الإدارة واختيار الخدمات والجدولة وتتبع الحجوزات ولوحات المعلومات. تم البناء باستخدام React و TypeScript و Supabase مع دمج روبوت محادثة ذكي لدعم العملاء.',
  'portfolio.project2.title': 'UC AIwan+',
